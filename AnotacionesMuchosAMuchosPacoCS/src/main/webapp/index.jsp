<%-- 
    Document   : index
    Created on : 8 feb. 2019, 16:59:17
    Author     : paco
--%>
        ...
        <div id="principal">
            <center>
                ...
                <div id="menuPrincipal">
                    ...
                    <li><a href="${contexto}/Eleccion?op=list" class="enlace">Listar por profesores</a></li>
                    <li><a href="${contexto}/Eleccion?op=listModulos" class="enlace">Listar por módulos</a></li>
