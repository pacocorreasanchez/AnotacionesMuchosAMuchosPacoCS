        ...
        switch (request.getParameter("op")) {
            case "add":
                ...
                for (int i = 1; i <= contadorModulos; i++) {
                    ...
                    if (!request.getParameter("selectModulo" + i).equals("vacio")) {
                ...
                break;
            case "delete":
                profesor = (Profesor) gdao.getById(Integer.parseInt(request.getParameter("registro")), Profesor.class);
                profesor.setModulos(null);//Establecemos los modulos a null para que el profesor que queremos borrar no tenga modulos (esos modulos serían borrados en cascada)
